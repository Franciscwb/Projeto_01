...
<html>
    <head>
        ...
        <link rel="icon" href="<?php echo INCLUDE_PATH; ?>favicon.ico" type="image/xicon" />
        <meta charset="utf-8" />
    </head>
    <body>
    ...
    <div class="overlay-loading">
        ...
        <script src='https://maps.googleapis.com/maps/api/js?v=3.ex&key=AIzaSyBOHqin0fY_uQRJhynUiLGkfuXLYbgsnq0'></script>

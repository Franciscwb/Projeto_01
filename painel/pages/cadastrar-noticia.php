    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <?php
            ...
            if(isset($_POST['acao'])){
                ...
                if($titulo == '' || $conteudo == ''){
                    Painel::alert('erro','Campo vázios não são permitidos!');
                    ...
                    if(Painel::imagemValida($capa)){
                        ...
                        $arr = ['categoria_id'=>$categoria_id,'titulo'=>$titulo,'connteudo'=>$conteudo,'capa'=>$imagem,'slug'=>$slug,'order_id'=>'0','nome_tabela'=>'tb_site.noticias'];
